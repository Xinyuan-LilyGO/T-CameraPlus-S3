...
void setup_scr_Music_list(lv_ui *ui)
{
    ...
    if (My_UI.Music_List_Total_Number == 0) // 如果没有歌曲
    {
        ...
        // Write style state: LV_STATE_DEFAULT for &style_Music_list_list_2_extra_btns_main_default
        static lv_style_t style_Music_list_list_2_extra_btns_main_default;
        ui_init_style(&style_Music_list_list_2_extra_btns_main_default);

        lv_style_set_pad_top(&style_Music_list_list_2_extra_btns_main_default, 5);
        lv_style_set_pad_left(&style_Music_list_list_2_extra_btns_main_default, 10);
        lv_style_set_pad_right(&style_Music_list_list_2_extra_btns_main_default, 0);
        lv_style_set_pad_bottom(&style_Music_list_list_2_extra_btns_main_default, 10);
        lv_style_set_border_width(&style_Music_list_list_2_extra_btns_main_default, 1);
        lv_style_set_border_opa(&style_Music_list_list_2_extra_btns_main_default, 255);
        lv_style_set_border_color(&style_Music_list_list_2_extra_btns_main_default, lv_color_hex(0x6f6969));
        lv_style_set_text_color(&style_Music_list_list_2_extra_btns_main_default, lv_color_hex(0xfef6ea));
        lv_style_set_text_font(&style_Music_list_list_2_extra_btns_main_default, &lv_font_simsun_16_cjk);
        lv_style_set_radius(&style_Music_list_list_2_extra_btns_main_default, 0);
        lv_style_set_bg_opa(&style_Music_list_list_2_extra_btns_main_default, 0);
        lv_obj_add_style(ui->Music_list_list_1_item0, &style_Music_list_list_2_extra_btns_main_default, LV_PART_MAIN | LV_STATE_DEFAULT);
