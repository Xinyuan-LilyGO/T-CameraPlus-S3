...
int Home_digital_clock_1_sec_value = 00;void setup_scr_Home(lv_ui *ui)
{
	//Write codes Home
	...
	lv_img_set_src(ui->Home_img_1, &_3_alpha_28x14);
	lv_img_set_pivot(ui->Home_img_1, 50,50);
	lv_img_set_angle(ui->Home_img_1, -10);
	lv_obj_set_pos(ui->Home_img_1, 200, 3);
	lv_obj_set_size(ui->Home_img_1, 28, 14);
