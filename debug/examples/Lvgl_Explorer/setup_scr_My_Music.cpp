...
void setup_scr_My_Music(lv_ui *ui)
{
	...
	ui->My_Music_list_1_item2 = lv_list_add_btn(ui->My_Music_list_1, LV_SYMBOL_DIRECTORY, "File system");
	...
	lv_obj_add_style(ui->My_Music_list_1_item2, &style_My_Music_list_1_extra_btns_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);
