 ...
 * @LastEditTime: 2023-11-22 11:21:54
 * @License: GPL 3.0
 */
...
void setup()
{
    ...
    SY6970->IIC_Write_Device_Value(SY6970->Arduino_IIC_Power::Device_Value::POWER_DEVICE_WATCHDOG_TIMER, 0);                // 禁用看门狗定时器喂狗功能
    SY6970->IIC_Write_Device_Value(SY6970->Arduino_IIC_Power::Device_Value::POWER_DEVICE_THERMAL_REGULATION_THRESHOLD, 60); // 热温度阈值调整为60度后降低充电电流
